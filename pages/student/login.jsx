...
const Login = () => {
  ...
  return (
    ...
    >
      <Head>
        <title>Student Login | Learning Management System - Teps PVT Ltd</title>
        <meta
          name="description"
          content="Log in to the Teps PVT Ltd Learning Management System (LMS) as a Student to access course materials, complete assignments, and communicate with teachers and classmates."
        />
        <meta name="robots" content="noindex, nofollow" />
        <link
          rel="canonical"
          href={`https://${process.env.NEXT_PUBLIC_DOMAINNAME}/student/login`}
        />

        <meta
          property="og:title"
          content="Student Login | Learning Management System - Teps PVT Ltd"
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://${process.env.NEXT_PUBLIC_DOMAINNAME}/student/login`}
        />
