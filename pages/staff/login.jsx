...
const Login = () => {
  ...
  return (
    ...
    >
      <Head>
        <title>Staff Login | Learning Management System - Teps PVT Ltd</title>
        <meta
          name="description"
          content="Log in to the Teps PVT Ltd Learning Management System (LMS) as a Staff member to access teaching materials, manage courses, and interact with students."
        />
        <meta name="robots" content="noindex, nofollow" />
        <link
          rel="canonical"
          href={`https://${process.env.NEXT_PUBLIC_DOMAINNAME}/staff/login`}
        />

        <meta
          property="og:title"
          content="Staff Login | Learning Management System - Teps PVT Ltd"
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://${process.env.NEXT_PUBLIC_DOMAINNAME}/staff/login`}
        />
