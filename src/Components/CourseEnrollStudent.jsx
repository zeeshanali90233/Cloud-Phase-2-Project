...
const CourseEnrollStudent = ({
  ...
  const [studentToEnrollForm, setStudentToEnrollForm] = useState({other:0});
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const feeReceipt = {
        ...
        totalfees: Number(studentToEnrollForm.fees)+Number(studentToEnrollForm.other),
        other:studentToEnrollForm.other,
      ...
      await db
        ...
        .update({
          ...
          studentsfee: firebase.firestore.FieldValue.arrayUnion(feedocRef.id),
        });
        ...
        <Box sx={style}>
          <div className="w-100 container mt-1">
            ...
            >
              <div className="row">
                ...
                <div className="d-flex flex-column col mt-2">
                  <TextField
                    ...
                    type="text"
                    name="sid"
                    title="The input should start with 's' or 'S' followed by 5 characters that can be either letters or numbers."
              ...
              <div className="row">
              <label htmlFor="duedate">Other(Rs)</label>
                {/* Others */}
                <div className="d-flex flex-column col mt-2">
                  <TextField
                    id="outlined-basic"
                    type="text"
                    name="other"
                    value={studentToEnrollForm.other}
                    onChange={(e) => {
                      handleChange(e);
                    }}
                  />
