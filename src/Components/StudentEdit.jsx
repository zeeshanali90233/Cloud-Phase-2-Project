...
const StudentEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      if(studentData.studentphoto.length!==0){
        await firebase
        .storage()
    ...
    if (
      ...
      if(studentData.studentcnicphoto.length!==0){
        await firebase
        .storage()
    ...
    if (
      ...
      if(studentData.parentcnicphoto.length!==0){
        await firebase
        .storage()
    ...
    <div className="add-student-form container mt-2 w-100 ">
      ...
      >
        ...
        <div className=" d-flex justify-content-center me-auto">
          <div>
            <img
              src={studentPhotoURL !== "" && studentPhotoURL ? studentPhotoURL  : emptyProfile}
              alt="studentPicture "
              width={130}
              className="rounded"
            />
