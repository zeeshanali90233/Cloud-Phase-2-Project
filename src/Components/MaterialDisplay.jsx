...
const MaterialDisplay = ({ firebaseId }) => {
  ...
  const handleShowAddFileBoxClose = () => {
    setShowAddFileBox(false);
  };
  const handleShowVideoLectureBoxClose = () => {
    ...
    <div className="w-100 container mt-1">
      ...
      {showAddMaterialButtons ? (
        <div className="btns d-flex w-100 justify-content-evenly flex-wrap mt-1">
          ...
          <div
            className="panel border addlecturefile d-flex flex-column px-3 py-2 align-items-center rounded justify-content-center"
            onClick={() => {
      ...
      {course && !showAddFileBox && !showAddVideoLectureBox ? (
        <FilePagination
          data={course.lectureFiles}
          outlineFile={course.courseOutlineFile}
          additionalDocs={course.courseAdditionalDocs}
            ...
            <Box sx={style}>
              ...
              >
                ...
                <div className="d-flex flex-column col">
                  ...
                  ></input>
                  {isInvalidLink ? (
                    <span className="required">Invalid Link</span>
                  ) : (
                    ""
                  )}
                </div>
