...
const StudentDetail = ({isStaff}) => {
  ...
  const handleResetPassword = (email) => {
    axios.post("https://lmsserver.up.railway.app/user/password-reset",{email:email}).then((res)=>{
  ...
  return (
    ...
    <div className="d-flex justify-content-end  w-100 ">
      ...
      {/* Edit Button */}
      <div>{((isStaff)?(user && user.studentauthority && user.studentauthority.edit )?true:false:true)?<div className="w-100 d-flex mt-2 justify-content-end pe-2">
        <button
          type="submit"
          id="edit-button"
          className="border rounded"
      ...
      <div className="studentphoto w-100 d-flex justify-content-center mt-2 mb-1">
        <img
          src={!isObjectEmpty(student) &&  student.studentphoto ? student.studentphoto.URL : emptyProfile}
          alt="studentPicture "
          width={150}
          className="rounded"
        />
      ...
      {!isObjectEmpty(student) ? (
        <div className="student-details container  w-100 ms-1 d-md-flex justify-content-center">
          <div className="w-100"> 
          <div className="row">
