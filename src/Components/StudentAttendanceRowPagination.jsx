...
const StudentAttendanceRowPagination = ( {student,attendanceData,courseId,courseName}) => {
    const rows = [student];
  ...
  return (
    <div className="mt-2" >
      <div className="percentage text-center d-flex justify-content-evenly w-100 flex-wrap">
       <div>
       Course ID:{courseId}
       </div>
       <div>
