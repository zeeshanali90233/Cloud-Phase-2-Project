...
const DuesPagination = ({ data}) => {
 ...
 const handleNavigationToDetail = (e,row) => {
  e.preventDefault();
      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        ...
        <TableBody>
          ...
          {(rowsPerPage > 0
           ...
           return(
              (row.id===search.toLowerCase() || row.name.toLowerCase().includes(search.toLowerCase()) || search.length===0)? <StyledTableRow key={row.firebaseId} style={{cursor:"pointer"}} onClick={(e)=>{handleNavigationToDetail(e,row)}}>
              <SalaryDisplay salary={row}/>
