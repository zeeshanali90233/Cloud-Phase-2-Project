...
const CourseFinancePage = () => {
  ...
  const getFeesData = async (e) => {
    ...
    if (
      courseDetail.data().studentsfee &&
      courseDetail.data().studentsfee.length !== 0
    ) {
      await Promise.all(
        courseDetail.data().studentsfee.map(async (feeId) => {
          ...
          <div className="w-100 mt-2 ">
            <div className="course-info container">
              <div className="w-100 d-flex justify-content-end">
                <abbr title="Print Report">
                  <PrintCourseFinance
                    courseFinanceDetail={courseFinanceDetail}
                  />
                </abbr>
              </div>
              <div className="row">
            ...
            <div className="container">
              {courseFinanceDetail.defaultersArr &&
              courseFinanceDetail.defaultersArr.length !== 0 ? (
                <FeePagination
                  data={courseFinanceDetail.defaultersArr}
                  pageSize={10}
                  isSuperAdmin={true}
                  isAdmin={false}
                  isStaff={false}
